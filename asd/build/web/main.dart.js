...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C2() {
      return C[2] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Лабораторная работа №1"
      });
    },
    get C3() {
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[2] || CT.C2, backgroundColor: theme.Theme.of(context).colorScheme.inversePrimary, foregroundColor: new ui.Color.fromARGB(255, 255, 255, 255)}), body: new basic.Column.new({children: T.JSArrayOfWidget().of([new container.Container.new({width: 200, height: 100, color: new ui.Color.fromARGB(255, 34, 79, 116), margin: C[3] || CT.C3}), new container.Container.new({width: 150, height: 80, color: colors.Colors.green, margin: C[3] || CT.C3}), new basic.Expanded.new({child: new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.spaceEvenly, children: T.JSArrayOfWidget().of([new circle_avatar.CircleAvatar.new({radius: 30}), new circle_avatar.CircleAvatar.new({radius: 50, backgroundColor: colors.Colors.red})])})})])}), floatingActionButton: new floating_action_button.FloatingActionButton.new({onPressed: dart.fn(() => {
            core.print("Button pressed!");
            this[_incrementCounter]();
          }, T.VoidTovoid()), tooltip: "Increment", child: C[4] || CT.C4})});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC5C4B;AACxB,YAAO,iCACE,wBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAmCX;;;;;;;;;;;;AAGsB;IAAkB;;;QAd7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA4B9C,MAPF,cAAS;AAMG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;UAG0B;AACxB,YAAO,oCACG,+DAEiB,AAAY,AAAY,eAArB,OAAO,+CACV,sBAAS,KAAK,KAAK,KAAK,cAE3C,gCACM,wBAER,oCACS,aACC,YACK,sBAAS,KAAK,IAAI,IAAI,+BAQrC,oCACS,aACC,WACM,8CAKhB,+BACS,sCACgC,8CAC3B,wBACR,4CACU,MAEV,4CACU,qBACgB,qDAOd,gEACT;AACe,YAAxB,WAAM;AACa,YAAnB;uCAEO;IAIf;;;;;;IApEI,iBAAW;;;EAqEjB;;;;;;;;;;;;;;AAnHuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
